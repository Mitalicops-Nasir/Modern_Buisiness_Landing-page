  ...
  return (
    <header
      className={clsx(
        ...
        isScrolled && "py-2 bg-black-100 backdrop-blur-[8px]"
      )}
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        <button
          className="lg:hidden z-2 size-10 border-2 borders4/25 rounded-full flex justify-center items-center"
